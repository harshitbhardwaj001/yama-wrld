import {
  ...
  const services = [
    ...
    {
      title: "Exclusive Membership with access to Yama Activations, airdrops, and experiences.",
      icon: mobile,
    },
    {
    ...
    {
      title: "Citizen Pass holders are guaranteed 1 free Yama NFT from our pfp collection launching in 2024.",
      icon: creator,
    },
  ];
