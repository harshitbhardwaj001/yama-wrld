    ...
    <LayoutStreet>
      ...
      <div className="my-[60px] mt-[11rem] mx-auto">
        ...
        >
          ...
          <div className="absolute z-100 lg:w-[30rem] lg:left-[11rem] lg:top-[8.5rem] md:w-[20rem] md:top-[5.5rem] md:left-[6rem] sm:w-[12rem] sm:top-[2.8rem] sm:left-[3.8rem] xs:w-[8rem] xs:top-[1.2rem] xs:left-[2.5rem]">
            <h1 className="text-white font-extralight text-center lg:text-[2rem] md:text-[1.2rem] sm:text-[.8rem] xs:text-[.5rem] lg:w-[380px]">
              Get in loser, we&apos;re going shopping. Yama Street is coming
              soon!
            </h1>
          </div>
        </motion.div>
