              ...
              <div className="contentBx active" id="content1">
                <div className="card">
                  ...
                  <div className="textBx">
                    ...
                    <ul className="sci">
                      <li>
                        <a href="https://twitter.com/0xnosh" target="_blank">
                ...
                <div className="card">
                  ...
                  <div className="textBx">
                    ...
                    <ul className="sci">
                      <li>
                        <a
                          href="https://twitter.com/Miss_Ghost_2022"
                          target="_blank"
                        >
                          <i className="fa-brands fa-twitter"></i>
                        </a>
                ...
                <div className="card">
                  ...
                  <div className="textBx">
                    ...
                    <ul className="sci">
                      <li>
                        <a
                          href="https://twitter.com/SquareKush"
                          target="_blank"
                        >
                          <i className="fa-brands fa-twitter"></i>
                        </a>
              ...
              <div className="contentBx" id="content4">
                <div className="card">
                  ...
                  <div className="textBx">
                    ...
                    <ul className="sci">
                      <li>
                        <a href="https://twitter.com/Kaffsu" target="_blank">
                          <i className="fa-brands fa-twitter"></i>
                        </a>
                      </li>
                    </ul>
                ...
                <div className="card">
                  ...
                  <div className="textBx">
                    <h2>
                      Ghost
                      <br />
                      <span>Security Moderator</span>
                    </h2>
                    <ul className="sci">
                      <li>
                        <a
                          href="https://twitter.com/Ghost_Rezin"
                          target="_blank"
                        >
                          <i className="fa-brands fa-twitter"></i>
                        </a>
                ...
                <div className="card">
                  ...
                  <div className="textBx">
                    ...
                    <ul className="sci">
                      <li>
                        <a
                          href="https://twitter.com/fullmetalbruh"
                          target="_blank"
                        >
                          <i className="fa-brands fa-twitter"></i>
                        </a>
